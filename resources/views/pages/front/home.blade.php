					...
					<div class="total-work-process d-flex justify-content-around align-items-left">		
						...
						<div class="row justify-content-center">
							...
							<div class="col-lg-5 col-md-10">										
								...
								<!--<input type="email" name="email" placeholder="Masukan No Tlp" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" class="common-input mt-20" required>-->
